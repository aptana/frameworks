...
YAHOO.widget.DateMath = {
	...
	* @return {Boolean} true if the date occurs between the 
	* compared dates; false if not.
	...
	* @return {Number}	The number of days since January 1 of the 
	* given year
	...
	* @return {Date}		The JavaScript Date representing the first 
	* day of the month
	...
	* @return {Date}		The JavaScript Date representing the last 
	* day of the month
	...
	* @return {Date}		The JavaScript Date cleared of all time 
	* fields
