...
var example_jquery = 'http://ajax.googleapis.com/ajax/libs/jquery/1.3.1/jquery.min.js'; // latest from google
    ...
    if (!xmldoc && typeof data != "undefined") {
        ...
        $.ajax({
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
				...
				alert("there was a load error with " + this.url + ": " + textStatus);
            },
            complete: function () {
                $(document).trigger('api-load-complete');
            }
...
//            $('function,property,selector', this).each(function () {
			$('function', this).add('property', this).add('selector', this).each(function () {
	            var data = {};
                guid++;
