dojo.registerModulePath("flashCards.src","../../src");
...
dojo.require("flashCards.src.MathFlashCard");
dojo.require("flashCards.src.Teacher");
...
dojo.addOnLoad(function(){
	...
	setTimeout(function(){
		new dojox.analytics.Urchin({ 
			acct: "UA-3572741-1", 
			GAonLoad: function(){
				this.trackPageView("/samples/flashCards");
			}
		});	
	}, 1500);
