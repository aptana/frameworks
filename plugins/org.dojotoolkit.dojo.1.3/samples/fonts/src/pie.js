...
(function(){
	fonts.src.pie = function(node, font, data, args){
		args = args || {};
		this.font = font;
		this.data = data || [];
		...
		this.center = args.center || this.radius + (this.stroke.width*2);
		this.width = args.width || this.center*2;
		this.height = args.height || this.center*2;
