dojo.provide("fonts.src.charts");
dojo.require("fonts.src.pie");
...
function init(){
	...
	//	create the charts
	var pie1 = new fonts.src.pie(dojo.byId("pie1"), font, set1);
	pie1.draw();
	
	var pie2 = new fonts.src.pie(dojo.byId("pie2"), font, set2, {
		fill: "#aeb31d",
		main: "#636608",
		rotation: 37.5
	});
	...
	var pie3 = new fonts.src.pie(dojo.byId("pie3"), font, set3, {
		fill: "#ffee00",
		main: "#b1e07b",
		stroke: "#4f6e2c",
		rotation: 180
