dojo.registerModulePath("faces.src", "../../src");
dojo.provide("dojoc.faces.src");

dojo.require("dojox.fx.flip");
dojo.require("faces.src.block");
...
(function(d){
	...
	var demo = function(){	
		...
		d.query("#setupSwf").onclick(function(e){
			...
			// d.require("dojoc.faces.src.webcam");
			d["require"]("dojoc.faces.src.webcam");
		}).forEach(function(n){
		...
		setTimeout(function(){
			new dojox.analytics.Urchin({ 
				acct: "UA-3572741-1", 
				GAonLoad: function(){
					this.trackPageView("/samples/faces");
				}
			});	
		}, 1500);
