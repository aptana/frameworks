dojo.registerModulePath("cropper.src","../../src");
dojo.provide("cropper.src");

dojo.require("cropper.src.Preview");
dojo.require("dojox.analytics.Urchin");
dojo.require("cropper.src.nav"); 
...
;(function(d, $){
	...
	d.addOnLoad(function(){
		...
		new dojox.analytics.Urchin({ 
			acct: "UA-3572741-1", 
			GAonLoad: function(){
				this.trackPageView("/samples/cropper");
			}
		});	
