dojo.registerModulePath("mojo.src","../../src");
dojo.provide("mojo.src");
...
// our custom code:
dojo.require("mojo.src.drop"); // gravity code
dojo.require("mojo.src.download"); // download link code
...
(function(){ 
	...
	dojo.addOnLoad(function(){
		...
		new dojox.analytics.Urchin({ 
			acct: "UA-3572741-1", 
			GAonLoad: function(){
				this.trackPageView("/samples/mojo");
			}
		});	
