...
set :application, "frameworks" # Which project are we pushing (this controls folder name used from Hudson and s3)
...
set :bucket_path_prefix, "tools/studio/plugin/install"
